...
int main(){
	...
	char numStr1[N], numStr2[N], sign1='0', sign2='0';
	...
	*/
	...
	switch(choice){
		case 1:
			...
			flag=compare(num1, num2, n1, n2);
			if((sign1=='-' && sign2=='0') || (sign2=='-' && sign1=='0')){
				if(flag){
